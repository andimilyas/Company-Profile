            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="item-card flex flex-row justify-between items-center">
                    ...
                    <div  class="hidden md:flex flex-col">
                        ...
                        <h3 class="text-indigo-950 text-xl font-bold">{{ $statistic->created_at->format('d M Y') }}</h3>
                    </div>
                    <div class="hidden md:flex flex-row items-center gap-x-3">
                        <a href="{{ route('admin.statistics.edit', $statistic->id) }}" class="font-bold py-4 px-6 bg-indigo-700 text-white rounded-full">
                            Edit
                        </a>
                ...
                <div class="flex flex-col items-center justify-center">
                    <h3 class="text-xl font-bold text-gray-800">No statistics found</h3>
                </div>
                @endforelse
            </div>
        </div>
